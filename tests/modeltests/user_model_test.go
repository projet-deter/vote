...
func TestSaveUser(t *testing.T) {
	...
	assert.Equal(t, newUser.Last_name, savedUser.Last_name)
}
...
func TestGetUserByID(t *testing.T) {
	...
	assert.Equal(t, foundUser.Last_name, user.Last_name)
}
...
func TestUpdateAUser(t *testing.T) {
	...
	assert.Equal(t, updatedUser.Last_name, userUpdate.Last_name)
}
